...
const Community = () => {
  ...
  return (
    <div className="p-6 pt-12 x1:px-12 2x1:px-20 w-full mx-auto
    h-full overflow-y-scroll">
     <h2 className="text-x1 font-semibold mb-6
        ...
        {images.map((item,index) => (
          <a key={index} href={item.imageUrl} target="_blank" className="relative group block rounded-lg overflow-hidden border border-gray-200 dark:border-purple-700
           shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            2x1:h-62 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out'/>

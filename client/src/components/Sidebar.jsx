...
// const { chats, setSelectedChats, theme, setTheme,
//    user,navigate,createNewChat,axios, setChats, fetchUsersChats,setToken
//   } = useAppContext()
...
//   <div onClick={()=>{navigate('/'); setSelectedChats(chat); setIsMenuOpen(false)}} key={chat._id} className='p-2 px-4 dark:bg-[#57317C]/10 border border-gray-300 dark:border-[#80609F]/15 rounded-md
...
//           </div>
//          <img src={assets.bin_icon} alt='' className='w-4  cursor-pointer hidden group-hover:block not-dark:invert'/>
//            </div> 
//   ))
//   }
...
// {/*community image*/}
// <div onClick={()=> {navigate('/community'); setIsMenuOpen(false)}} className="flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-105 transition-all">
...
// </div>
// {/*credits purchase*/}
// <div onClick={()=> {navigate('/credits'); setIsMenuOpen(false)}} className="flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-105 transition-all">
...
//       </div>
//       <img onClick={e=> toast.promise(deleteChat(e, chat._id), {loading:'deleting...'})} src={assets.close_icon} className='absolute top-3 right-3 w-5 h-5 cursor-pointer md:hidden not-dark:invert' alt='Close'/>
//     </div>
